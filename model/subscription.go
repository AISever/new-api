...
func CompleteSubscriptionOrder(tradeNo string, providerPayload string, expectedPaymentProvider string, actualPaymentMethod string) error {
	...
	if logUserId > 0 {
		...
		if err = grantInviteRatioReward(logUserId, logMoney); err != nil {
			common.SysError("grant invite ratio reward failed after subscription order completion: " + err.Error())
		}
	}
	return nil
}
