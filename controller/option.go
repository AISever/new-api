...
func UpdateOption(c *gin.Context) {
	...
	case "ModelPriceItems":
		err = ratio_setting.UpdateModelPriceItemsByJSONString(option.Value.(string))
		if err != nil {
			c.JSON(http.StatusOK, gin.H{
				"success": false,
	...
	case "HelpGroupCards":
		_, err = setting.ValidateHelpGroupCardsJSON(option.Value.(string))
		if err != nil {
			c.JSON(http.StatusOK, gin.H{
				"success": false,
				"message": "群聊卡片配置无效: " + err.Error(),
			})
			return
		}
