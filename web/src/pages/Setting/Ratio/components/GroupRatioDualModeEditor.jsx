          ...
          <>
            ...
            <div style={{ marginTop: 8 }}>
              <Button
                ...
                theme='light'
                onClick={() =>
                  rebuildCardRowsFromJson('groupGroupRatio', parseGroupRelationOption)
                }
              >
                {t('用当前 JSON 刷新表格')}
              </Button>
      ...
      <OptionModeCard
        ...
        tableContent={
          <OperationRuleTableEditor
            ...
            onDeleteRow={(rowId) =>
              deleteRow('groupSpecialUsableGroup', rowId)
            }
            onChangeRow={(rowId, field, value) =>
          ...
          <>
            ...
            <div style={{ marginTop: 8 }}>
              <Button
                ...
                theme='light'
                onClick={() =>
                  rebuildCardRowsFromJson('autoGroups', parseOrderedStringListOption)
                }
              >
                {t('用当前 JSON 刷新表格')}
              </Button>
