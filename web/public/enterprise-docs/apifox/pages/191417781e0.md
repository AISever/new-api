  ...
  /rerank:
    post:
      ...
      description: >-
        ...
        简介：Jina AI Rerank
        是一个强大的文本重排序模型，可以根据查询对文档列表进行相关性排序。该模型支持多语言，可以处理不同语言的文本内容，并为每个文档分配相关性分数。
      tags:
        - 模型接口/重排序 (Rerank)
      parameters:
        - name: Content-Type
          ...
          application/json:
            ...
            example:
              ...
              documents:
                ...
                - >-
                  Capitalization or capitalisation in English grammar is the use
                  of a capital letter at the start of a word. English usage
                  varies from capitalization in other languages.
                - >-
      ...
      x-run-in-apifox: https://app.apifox.com/web/project/3593080/apis/api-191417781-run
components:
  schemas: {}
  securitySchemes: {}
servers:
