...
paths:
  /chat/completions:
    post:
            ...
            application/json:
              schema:
                ...
                x-apifox-orders:
                  ...
                  - usage
              example:
                id: chatcmpl-CQiTrIQOdRshzeVD6inkEQ9gQTfuy
                ...
                choices:
                  - index: 0
                    message:
                      role: assistant
                      content: >-
                        这是一张包含“CAT”字样的图片，左侧有一个抽象的猫形图案，其中使用了渐变的蓝色和紫色。这可能是一个品牌的标志或logo。
                      refusal: null
                      annotations: []
                    logprobs: null
                    finish_reason: stop
      ...
      x-run-in-apifox: https://app.apifox.com/web/project/3593080/apis/api-126569015-run
components:
  schemas: {}
  securitySchemes: {}
servers:
