...
paths:
  /chat/completions:
    post:
      summary: runway
      deprecated: false
      description: 文生视频模型，已统一接口，可直接chat格式调用：runway-video、runway-vip-video（更快无水印）
      tags:
      ...
      x-run-in-apifox: https://app.apifox.com/web/project/3593080/apis/api-220097541-run
components:
  schemas: {}
  securitySchemes: {}
servers:
