...
paths:
  /messages:
    post:
      summary: Web search / 联网搜索
      deprecated: false
      description: 支持官方原生格式，模型名称和官方一致
      tags:
      ...
      responses:
        '200':
          ...
          x-apifox-name: OK
      security: []
      x-apifox-folder: 模型接口/聊天(Chat)/Anthropic Claude/原生Claude格式(推荐)
      x-apifox-status: released
      x-run-in-apifox: https://app.apifox.com/web/project/3593080/apis/api-313863787-run
components:
  schemas: {}
  securitySchemes: {}
servers:
