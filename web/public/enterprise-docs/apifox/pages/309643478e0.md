  ...
  /chat/completions:
    post:
      ...
      description: >-
        ...
        官方文档：https://platform.openai.com/docs/guides/pdf-files?api-mode=chat&lang=python
      tags:
      ...
      x-run-in-apifox: https://app.apifox.com/web/project/3593080/apis/api-309643478-run
components:
  schemas: {}
  securitySchemes: {}
servers:
