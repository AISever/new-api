...
paths:
  /chat/completions:
    post:
      ...
      deprecated: false
      description: |-
        【gemini-2.5-flash-all】多模态版本的 gemini 模型，支持文件，视频，图片等分析，支持画图，支持实时联网
        【gemini-2.5-pro-all】多模态版本的 gemini 模型，支持文件，视频，图片等分析，支持画图，支持实时联网
        【gemini-2.5-flash-deepsearch】目前最好用的深度搜索模型，比 openai 和 grok 的都好用
        【gemini-2.5-pro-deepsearch】目前最好用的深度搜索模型，比 openai 和 grok 的都好用
      tags:
        - 模型接口/聊天(Chat)/Google Gemini/OpenAI兼容格式
      parameters:
        - name: Content-Type
          in: header
          description: ''
      ...
      responses:
        '200':
          ...
          x-apifox-name: OK
      security: []
      x-apifox-folder: 模型接口/聊天(Chat)/Google Gemini/OpenAI兼容格式
      x-apifox-status: released
      x-run-in-apifox: https://app.apifox.com/web/project/3593080/apis/api-305585040-run
components:
  schemas: {}
  securitySchemes: {}
servers:
