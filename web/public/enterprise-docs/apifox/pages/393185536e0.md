...
paths:
  /chat/completions:
    post:
      summary: 文本生成 / 自定义思考预算
      deprecated: false
      description: >-
        和Claude不同，默认情况下Gemini的思考模型会自动决定要不要思考，可使用【-thinking-预算数字】格式来精确传递思考预算，例如gemini-2.5-pro-preview-06-05-thinking-128
      tags:
      ...
      x-run-in-apifox: https://app.apifox.com/web/project/3593080/apis/api-393185536-run
components:
  schemas: {}
  securitySchemes: {}
servers:
