...
paths:
  /chat/completions:
    post:
        ...
        content:
          application/json:
            ...
            example:
              messages:
                - role: user
                  content: 特写镜头，清晨的阳光，一只鹦鹉站在红色的邮箱上，鹦鹉有着亮蓝色的羽毛，黄色的喙，背景是嘈杂的街道
              stream: true
              model: kling-video-std-5s
      responses:
        '200':
          description: ''
          content:
      ...
      x-run-in-apifox: https://app.apifox.com/web/project/3593080/apis/api-238000703-run
components:
  schemas: {}
  securitySchemes: {}
servers:
