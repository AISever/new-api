...
paths:
  /chat/completions:
    post:
                ...
                - role: user
                  content:
                    ...
                    - type: image_url
                      image_url:
                        url: >-
                          https://s3plus-shon.meituan.net/multimodal-eval/audio2txt/self_built/audios/202502081700/31-2.mp3
                    - type: image_url
                      image_url:
                        url: >-
                          https://ossfiles.szeac.com/prod/oms/default/20241129/50c7062055f4d71f7ffb1bdc1034f47c.pdf
      responses:
        '200':
          description: ''
          content:
      ...
      x-run-in-apifox: https://app.apifox.com/web/project/3593080/apis/api-293081025-run
components:
  schemas: {}
  securitySchemes: {}
servers:
