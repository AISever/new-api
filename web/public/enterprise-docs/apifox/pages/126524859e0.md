...
paths:
  /chat/completions:
    post:
        ...
        content:
          application/json:
            ...
            example:
              ...
              messages:
                - role: user
                  content: https://ooo.0x0.ooo/2023/10/15/O7aNjK.png 分析一下钱多多的logo
      responses:
        '200':
          description: ''
          content:
      ...
      x-run-in-apifox: https://app.apifox.com/web/project/3593080/apis/api-126524859-run
components:
  schemas: {}
  securitySchemes: {}
servers:
