...
| `str` | `str(value) → string` | Converts a request value to string for selector comparisons |
| `num` | `num(value) → float64` | Converts a request value to number for duration/count calculations |
